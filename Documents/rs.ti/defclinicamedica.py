...
def buscar_consulta_por_data():
    ...
    if consultas_encontradas:
        ...
        for consulta in consultas_encontradas:
            print(f"Paciente: {consulta['Paciente']['Nome']}, Médico: {consulta['Médico']['Nome']}, Descrição: {consulta['Descrição']}")
    else:
...
def buscar_consulta_por_paciente():
    ...
    if consultas_encontradas:
        print(f"\nConsultas encontradas para {paciente['Nome']}:")
        for consulta in consultas_encontradas:
            print(f"Médico: {consulta['Médico']['Nome']}, Data: {consulta['Data']}, Descrição: {consulta['Descrição']}")
    else:
